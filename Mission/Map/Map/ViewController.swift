...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    @IBAction func sgChangeLocation(_ sender: UISegmentedControl) {
        if sender.selectedSegmentIndex == 0 {
            ...
            lblLocationInfo1.text = "보고 계신 위치"
            lblLocationInfo2.text = "이지퍼블리싱 출판사"
        }
        else if sender.selectedSegmentIndex == 3 {
            setAnnotation(latitudeValue: 37.468406, longitudeValue: 126.886497, delta: 0.1, title: "대륭테크노타운", subtitle: "서울시 금천구 가산디지털1로 19")
            lblLocationInfo1.text = "우리집"
            lblLocationInfo2.text = "대륭테크노타운 18차"
        }
    }
